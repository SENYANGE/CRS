...
public class ReportedComplaints extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reported_complaints);
...
//      getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        SendFilesButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder=new AlertDialog.Builder(ReportedComplaints.this);
    ...
    private void IntializeControllers()
    {
        ...
        SendMessageButton = (ImageView) findViewById(R.id.pbtn_send_mess_chat);
        SendFilesButton = (ImageView) findViewById(R.id.pbtn_send_file);

        storageReference= FirebaseStorage.getInstance().getReference().child("images");
        RootRef=FirebaseDatabase.getInstance().getReference().child("CRS");
        fuser=FirebaseAuth.getInstance().getCurrentUser();

        MessageInputText = (EditText) findViewById(R.id.pyourmessage_chat);

        userMessagesList = (RecyclerView) findViewById(R.id.precycler_chat_message);
                        ...
                        Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                            ...
                            public void onComplete(@NonNull Task<Uri> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    Toast.makeText(ReportedComplaints.this, "Profile Image uploaded Successfully...", Toast.LENGTH_SHORT).show();


                                } else {
                                    String message = task.getException().toString();
                                    Toast.makeText(ReportedComplaints.this, "Error: " + message, Toast.LENGTH_SHORT).show();
    ...
    private void readmessage(final String Sender, final String receiver, final String imageurl){
        ...
        DatabaseReference reference =FirebaseDatabase.getInstance().getReference().child("CRS").child("Messages");
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                messageAdapter1 = new messageAdapter(messagesList, ReportedComplaints.this, imageurl);
                userMessagesList.setAdapter(messageAdapter1);
